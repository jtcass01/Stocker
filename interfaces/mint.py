#/usr/bin/env python
"""mint.py: Code initially written by Mike Rooney.  Implementation was downloaded from https://github.com/mrooney/mintapi
and changes have been made to suit my uses."""

__author__ = "Mike Rooney, Jacob T. Cassady"
